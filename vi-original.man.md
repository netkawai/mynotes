...
mime     Imitating a smart act5     Intelligent 
...
giving the command \fB:se redraw\fR\s-2ESC\s0.  This simulation generates 
...
sections     sect=NHSH     Macro names which start new sections 
